...
\fancyfoot[L]{\small Master 2 Open Data et Web des Données}
...
\begin{titlepage}
    ...
    \vspace{1.5cm}
    {\large Master 2 Open Data et Web des Données\par}
    {\large Université de Montpellier Paul Valéry | Master 2 MIASHS | Novembre 2025\par}
    \vspace{2cm}
...
\begin{itemize}[leftmargin=*]
    ...
    \item Version adaptée AurorAlerte : [votre repository GitHub]
...
\vspace{0.8cm}
Master 2 Open Data et Web des Données\\
\end{center}
